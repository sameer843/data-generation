...
file_names=["استفعل","فعل","استفعال","افتعال","افتعل","افعل","تفعل",
"تفعيل","فاعل","فعال","فعيل","مستفعل","مفاعيل","مفتعلات","مفعل","مفعول",
"يستفعل","يفتعل","يفعل","افع","فاع","فل","حرف"]
k=0
al=0
faa=0
words=[]
...
for fname in file_names:
    ...
    with open ("very_light_stem_patterns/{}.txt".format(fname),"r", encoding="utf-8") as file:
        ...
        for i in start_numbers:
            for f in middle_numbers:
                for y in end_numbers:
                    if i !=f and f!=y:
                        if fname=="فاع" and i!=10 and i!=330 and y!=10 and y!=330:
                            root=[]
                            word=[]
                        ...
                        elif fname=="افع" and i!=10 and i!=330:
                            root=[]
                            word=[]
                            ...
                            for line in file_read:
                                ...
                                roots.append(root)
                        elif fname=="افتعال" or fname=="افعال" and i!=10 and i!=330 and f!=10 and f!=330 and y!=10 and y!=330:
                            root=[]
                            word=[]
                        ...
                        elif fname=="استفعال" and f!=10 and f!=330 and y!=10 and y!=330:
                            root=[]
                            word=[]
                        ...
                        elif fname=="مفعول" and f!=270 and y!=270:
                            root=[]
                            word=[]
                        ...
                        elif fname=="مفاعيل" and i!=10 and i!=330 and f!=10 and f!=330:
                            root=[]
                            word=[]
                        ...
                        elif fname=="تفعيل" and f!=280 and f!=290 and y!=280 and y!=290:
                            root=[]
                            word=[]
                        ...
                        elif fname=="افعل" and i!=10 and f!=330:
                            root=[]
                            word=[]
                        ...
                        elif fname=="فاعل" and i!=10 and i!=330 and f!=10 and f!=330:
                            root=[]
                            word=[]
                        ...
                        elif fname=="يفتعل" or fname=="يفعل" and i!=280 and i!=290:
                            root=[]
                            word=[]
...
file_path="words_very_light_revised5.txt"
write_list_to_file(file_path,words)

file_path="roots_roots_very_light_revised5.txt"
